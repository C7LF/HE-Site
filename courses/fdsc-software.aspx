<%@ Page Title="FdSc Software Development" Language="C#" MasterPageFile="~/courses/courses.master" AutoEventWireup="true" CodeFile="fdsc-software.aspx.cs" Inherits="fdsc_software" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="Server">
  <div class="article" style="background-image:url('https://placeimg.com/1900/300/tech')">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>FdSc in Computer Software Development</h1>
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <ul>
                <li>Software design and modelling</li>
                <li>Web applications</li>
                <li>Dynamic websites</li>
                <li>Programming and testing</li>
                <li>Programming and systems</li>
            </ul>
