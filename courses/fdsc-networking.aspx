<%@ Page Title="FdSc Computer Newtworking" Language="C#" MasterPageFile="~/courses/courses.master" AutoEventWireup="true" CodeFile="fdsc-networking.aspx.cs" Inherits="fdsc_networks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="Server">
  <div class="article" style="background-image:url('https://placeimg.com/1900/300/tech')">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>FdSc in Computer Networks</h1>
                    <p class="catblogs">Next Erollment: <strong>September <asp:Label ID="YearLabel" runat="server" Text=""></asp:Label></strong></p>
                    <a class="btn btn-danger" target="_blank" href="https://www.chesterfield.ac.uk/courses/apply?course_category_id=13&course_id=785">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <ul>
                <li>Two A Levels or a relevant BTEC diploma</li>
                <li>GCSE English and maths at grade C or above (or Level 2 equivalent)</li>
                <li>Mature students with relevant experience will also be considered</li>
            </ul>
            <br />
        ...
        <div class="col-sm-3 panel aftc sidebarcourse">
            ...
            <p>FT courses only</p>
            <br />
            <a href="https://www.chesterfield.ac.uk/courses/apply?course_category_id=13&course_id=785" target="_blank" class="btn btn-block btn-primary btn-lg">Apply Now</a>
            <br />
        </div>
        </div>
    </div>
